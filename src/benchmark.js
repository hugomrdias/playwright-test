...
(function() {
    ...
    function runInContext(context) {
       ...
       */
        function isHostType(object, property) {
            ...
            return !rePrimitive.test(type) && (type != 'object' || Boolean(object[property]));
        }
       ...
       */
        function compare(other) {
            ...
            function getScore(xA, sampleB) {
                return _.reduce(sampleB, (total, xB) => total + (xB > xA ? 0 : xB < xA ? 1 : 0.5), 0);
            }

            function getU(sampleA, sampleB) {
                return _.reduce(sampleA, (total, xA) => total + getScore(xA, sampleB), 0);
            }
       ...
       */
        ...
        _.each(['each', 'forEach', 'forOwn', 'has', 'indexOf', 'map', 'reduce'], (methodName) => {
       ...
       */
        ...
        _.each(['each', 'forEach', 'indexOf', 'map', 'reduce'], (methodName) => {
    ...
    if (typeof define == 'function' && typeof define.amd == 'object' && define.amd) {
        ...
        define(['lodash', 'platform'], (_, platform) => runInContext({
            '_': _,
            'platform': platform
        }));
    } else {
